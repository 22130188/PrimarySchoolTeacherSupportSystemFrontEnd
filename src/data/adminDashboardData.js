import {
  ...
  ClipboardCheck, PanelsTopLeft, MessageSquareWarning, BookMarked, Globe2,
} from 'lucide-react';
...
export const ADMIN_MENU = [
  ...
  { key: 'categories', label: 'Quản lý Danh Mục', icon: GraduationCap },
  { key: 'lesson_content', label: 'Nội dung Bài Học', icon: FileText },
  ...
  { key: 'public_lessons', label: 'Bài giảng công khai', icon: Globe2 },
