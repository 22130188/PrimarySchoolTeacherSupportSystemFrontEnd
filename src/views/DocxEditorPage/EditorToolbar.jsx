          ...
          <>
            {shapeFormat.hasFill && (
              <div className="relative shrink-0">
                <button className={EDITOR_BTN} onClick={() => setShowFillPicker(!showFillPicker)} title="Màu nền hình" id="editor-shape-fill-btn">
                  <Palette size={15} />
            ...
            <div className="relative shrink-0">
              <button className={EDITOR_BTN} onClick={() => setShowStrokePicker(!showStrokePicker)} title="Màu viền hình" id="editor-shape-stroke-btn">
                <Minus size={15} />
            ...
            <div className="flex items-center border border-gray-200 rounded-md overflow-hidden h-8 shrink-0">
              <button onClick={() => adjustStrokeWidth(-1)} id="editor-shape-stroke-dec"
              ...
              <input type="text" value={shapeFormat.strokeWidth ?? 2} onChange={handleStrokeWidthInput} id="editor-shape-stroke-width"
              ...
              <button onClick={() => adjustStrokeWidth(1)} id="editor-shape-stroke-inc"
                className="w-[26px] h-full border-none bg-transparent text-gray-500 cursor-pointer flex items-center justify-center transition-all hover:bg-gray-100 hover:text-indigo-600">
                <Plus size={12} />
              </button>
            </div>
