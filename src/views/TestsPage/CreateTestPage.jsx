...
//   ];
//
//   // Options for lesson content — use local dataset as fallback, API will be merged
...
//         // data expected as array of { subject, grade, name }
//         // merge API data with local fallback without duplicates
//         const apiList = data || [];
...
//   });
//
//   // If a lessonContentName exists (e.g., when editing) and is not present in options
//   // for the selected subject/grade, enable the "other" input mode and populate it.
//   useEffect(() => {
//     if (!testInfo || !testInfo.lessonContentName) return;
//     const selectedGrade = testInfo.grade || '';
//     const found = contentOptions.find((c) => c.name === testInfo.lessonContentName && c.subject === testInfo.subject && (c.grade === selectedGrade || (selectedGrade && selectedGrade.startsWith(c.grade))));
//     if (!found && testInfo.lessonContentName !== '') {
//       setIsOtherSelected(true);
//       setCustomLessonContent(testInfo.lessonContentName);
//     }
//   }, [contentOptions, testInfo && testInfo.lessonContentName, testInfo && testInfo.subject, testInfo && testInfo.grade]);
//
...
//       const questions = await testApi.getFilteredQuestions(filterType, filterSubject, filterLessonContent);
...
//       setTestInfo((prev) => ({ ...prev, lessonContentName: '' }));
//     }
//   };
//
...
//                   <div>
//                     <label className="block text-sm font-medium text-gray-700 mb-2">
//                       Tên nội dung bài học
//                     </label>
//                     {!isOtherSelected ? (
//                       <select
//                         value={testInfo.lessonContentName || ''}
//                         onChange={(e) => {
//                           const v = e.target.value;
//                           if (v === '__other__') {
//                             setIsOtherSelected(true);
//                             setCustomLessonContent('');
//                             handleTestInfoChange('lessonContentName', '');
//                           } else {
//                             setIsOtherSelected(false);
//                             handleTestInfoChange('lessonContentName', v);
//                           }
//                         }}
//                         className="w-full px-4 py-2 rounded-lg border border-gray-200 bg-white outline-none focus:border-orange-300 focus:ring-2 focus:ring-orange-100 transition-all"
//                       >
...
//                         {contentOptions
//                           .filter((c) => {
//                             if (!testInfo.subject || !testInfo.grade) return false;
//                             return (
//                               c.subject === testInfo.subject &&
//                               normalizeGrade(testInfo.grade) === normalizeGrade(c.grade)
//                             );
//                           })
//                           .map((c) => (
//                             <option key={`${c.subject}-${c.grade}-${c.name}`} value={c.name}>
//                               {c.name}
//                             </option>
//                           ))}
...
//                       <input
//                         type="text"
//                         value={testInfo.lessonContentName || customLessonContent}
//                         onChange={(e) => {
//                           const v = e.target.value;
//                           setCustomLessonContent(v);
//                           handleTestInfoChange('lessonContentName', v);
//                         }}
//                         onBlur={() => {
//                           // keep isOtherSelected true until user explicitly chooses another option
//                         }}
//                         placeholder="Nhập tên nội dung bài học"
//                         className="w-full px-4 py-2 rounded-lg border border-gray-200 outline-none focus:border-orange-300 focus:ring-2 focus:ring-orange-100 transition-all"
//                       />
//                     )}
//                   </div>
...
//                     }}
//                     className="w-full px-2 py-1 text-xs border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-orange-300"
//                   >
...
//                   <select
//                     value={filterLessonContent}
//                     onChange={(e) => setFilterLessonContent(e.target.value)}
//                     className="w-full px-2 py-1 text-xs border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-orange-300"
//                   >
//                     <option value="">Tất cả bài học</option>
//                     {contentOptions.map((content) => (
//                       <option key={`${content.subject}-${content.grade}-${content.name}`} value={content.name}>
//                         {content.name}
//                       </option>
//                     ))}
//                   </select>
...
//                     className="w-full px-3 py-1 bg-orange-500 text-white text-xs font-medium rounded-lg hover:bg-orange-600 transition-colors"
//                   >
//                     Lọc
//                   </button>
//                 </div>
...
//                 <div className="text-center py-8">
//                   <p className="text-gray-600">Không tìm thấy câu hỏi nào.</p>
//                 </div>
//               ) : (
//                 <div className="space-y-3">
...
//                             </span>
//                             {question.subject && (
//                               <span className="text-xs text-gray-600 bg-blue-50 text-blue-700 px-2 py-1 rounded">
//                                 {question.subject}
//                               </span>
//                             )}
//                             {question.lessonContentName && (
//                               <span className="text-xs text-gray-600 bg-green-50 text-green-700 px-2 py-1 rounded">
//                                 {question.lessonContentName}
//                               </span>
//                             )}
//                           </div>
...
//                               <span className="font-medium">Tác giả:</span> {question.createdByName}
//                             </div>
//                           )}
//                         </div>
...
//               <button
//                 onClick={() => setShowQuestionDetailModal(false)}
//                 className="p-2 hover:bg-gray-100 rounded-full"
//               >
//                 <X className="w-5 h-5 text-gray-500" />
//               </button>
...
//                     {selectedQuestionDetail.type === 'MULTIPLE_CHOICE' ? 'Trắc nghiệm' :
//                      selectedQuestionDetail.type === 'AUDIO' ? 'Âm thanh' :
//                      selectedQuestionDetail.type === 'MATCHING' ? 'Nối từ' :
//                      selectedQuestionDetail.type === 'FILL_IN_BLANK' ? 'Điền khuyết' :
//                      selectedQuestionDetail.type === 'ESSAY' ? 'Tự luận' : 'Không xác định'}
//                   </p>
//                 </div>
//                 <div>
...
//                     {selectedQuestionDetail.content || selectedQuestionDetail.title || 'Không có nội dung'}
//                   </p>
//                 </div>
//               </div>
//
...
//                         <span className="text-xs font-semibold bg-gray-200 px-2 py-1 rounded min-w-[24px] text-center">
//                           {answer.label}
//                         </span>
//                         <span className={`text-sm ${answer.isCorrect ? 'text-green-700 font-semibold' : 'text-gray-700'}`}>
//                           {answer.content}
//                         </span>
...
//                   {selectedQuestionDetail.transcript && (
//                     <p className="text-xs text-gray-600 mt-2"><strong>Transcript:</strong> {selectedQuestionDetail.transcript}</p>
//                   )}
//                 </div>
//               )}
//
...
//               <button
//                 onClick={() => {
//                   addExistingQuestion(selectedQuestionDetail);
            ...
            <div className="space-y-4">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                <input
                    ...
                    value={question.title}
                    onChange={(e) =>
                        handleMultipleChoiceUpdate(question.id, 'title', e.target.value)
                    }
                    placeholder="Tên đề"
                    className="px-4 py-2 rounded-lg border border-gray-200 outline-none focus:border-orange-300 focus:ring-2 focus:ring-orange-100 transition-all"
                />
                <input
                    ...
                    value={question.points}
                    onChange={(e) =>
                        handleMultipleChoiceUpdate(question.id, 'points', e.target.value)
                    }
                    placeholder="Điểm"
                    className="px-4 py-2 rounded-lg border border-gray-200 outline-none focus:border-orange-300 focus:ring-2 focus:ring-orange-100 transition-all"
                />
              ...
              <div>
                ...
                <textarea
                    value={question.content}
                    onChange={(e) =>
                        handleMultipleChoiceUpdate(question.id, 'content', e.target.value)
                    }
                    placeholder="Nhập nội dung câu hỏi"
                    className="w-full px-4 py-3 rounded-lg border border-gray-200 outline-none focus:border-orange-300 focus:ring-2 focus:ring-orange-100 transition-all resize-none"
                    rows="4"
                ...
                <div className="flex flex-wrap gap-3 items-center">
                  <label className="inline-flex items-center gap-2 px-4 py-2 rounded-lg bg-gray-100 cursor-pointer text-sm font-medium text-gray-700 hover:bg-gray-200">
                    ...
                    <input
                        ...
                        accept="image/*"
                        onChange={(e) =>
                            handleUploadQuestionImage(question.id, e.target.files?.[0])
                        }
                        className="hidden"
                    />
                  </label>
                  ...
                  <span className="font-semibold text-gray-700 w-6">
                    {answer.label}:
                      ...
                      <input
                          ...
                          value={answer.content}
                          onChange={(e) =>
                              handleAnswerUpdate(question.id, answer.id, 'content', e.target.value)
                          }
                          placeholder={`Nhập đáp án ${answer.label}`}
                          className="flex-1 px-3 py-2 rounded-lg border border-gray-200 outline-none focus:border-orange-300 focus:ring-2 focus:ring-orange-100 transition-all"
                      />
                      <input
                          ...
                          checked={answer.isCorrect}
                          onChange={(e) =>
                              handleAnswerUpdate(question.id, answer.id, 'isCorrect', e.target.checked)
                          }
                          className="w-5 h-5 cursor-pointer rounded"
                          title="Chọn đáp án đúng"
                      />
            ...
            <div className="space-y-4">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                <input
                    ...
                    value={question.content}
                    onChange={(e) =>
                        handleAudioQuestionUpdate(question.id, 'content', e.target.value)
                    }
                    placeholder="Nội dung câu hỏi"
                    className="px-4 py-2 rounded-lg border border-gray-200 outline-none focus:border-orange-300 focus:ring-2 focus:ring-orange-100 transition-all"
                />
                <input
                    ...
                    value={question.points}
                    onChange={(e) =>
                        handleAudioQuestionUpdate(question.id, 'points', e.target.value)
                    }
                    placeholder="Điểm"
                    className="px-4 py-2 rounded-lg border border-gray-200 outline-none focus:border-orange-300 focus:ring-2 focus:ring-orange-100 transition-all"
                />
                  ...
                  <div className="flex flex-wrap gap-3 items-center">
                    ...
                    <label className="inline-flex items-center gap-2 px-4 py-2 rounded-lg bg-gray-100 cursor-pointer text-sm font-medium text-gray-700 hover:bg-gray-200">
                      ...
                      <input
                          ...
                          accept="audio/*"
                          onChange={(e) =>
                              handleUploadQuestionAudio(question.id, e.target.files?.[0])
                          }
                          className="hidden"
                      />
                    </label>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
                    <div>
                      ...
                      <input
                          type="text"
                          value={testInfo.name}
                          onChange={(e) => handleTestInfoChange('name', e.target.value)}
                          placeholder="Nhập tên bài kiểm tra"
                          className="w-full px-4 py-2 rounded-lg border border-gray-200 outline-none focus:border-orange-300 focus:ring-2 focus:ring-orange-100 transition-all"
                      />
                    </div>
                    ...
                    <div>
                      ...
                      <input
                          type="number"
                          value={testInfo.duration}
                          onChange={(e) => handleTestInfoChange('duration', e.target.value)}
                          placeholder="Thời gian (phút)"
                          className="w-full px-4 py-2 rounded-lg border border-gray-200 outline-none focus:border-orange-300 focus:ring-2 focus:ring-orange-100 transition-all"
                      />
                    </div>
