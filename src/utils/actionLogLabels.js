...
const EXACT_LABELS = {
  ...
  REQUEST_PASSWORD_RESET_OTP: 'Yêu cầu OTP đặt lại mật khẩu',
  VERIFY_PASSWORD_RESET_OTP: 'Xác thực OTP đặt lại mật khẩu',
...
export const ACTION_FILTER_OPTIONS = [
  ...
  { value: 'REQUEST_PASSWORD_RESET_OTP', label: 'Yêu cầu OTP đặt lại mật khẩu' },
  { value: 'VERIFY_PASSWORD_RESET_OTP', label: 'Xác thực OTP đặt lại mật khẩu' },
